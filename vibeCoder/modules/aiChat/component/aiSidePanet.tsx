...
export const AIChatSidePanel: React.FC<AIChatSidePanelProps> = ({
  ...
  const handleSendMessage = async (e: React.FormEvent) => {
    ...
    setInput("");
    await sendMessage(input, model, chatMode);
  };
  ...
  const filteredMessages = messages.filter((msg) => {
    ...
    const matchesFilter = filterType === "all" || (filterType === "chat" ? !msg.mode || msg.mode === "chat" : msg.mode === filterType);
                ...
                <div className="flex items-center gap-2">
                  <div className="hidden sm:flex items-center gap-2 text-xs text-zinc-400">
                    ...
                    >
                      ...
                      <option value="qwen3:1.7b">qwen</option>
                    </select>
                  </div>
