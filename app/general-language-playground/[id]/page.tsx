...
const PlaygroundHomePage = () => {
    ...
    const { playGroundData, templateData, saveTemplate, compile, error: previous, isLoading: previousLoading, socketUrl: previousUrl, containerId: previousContainer } = usePlaygroundForGeneralLanguage(id)
