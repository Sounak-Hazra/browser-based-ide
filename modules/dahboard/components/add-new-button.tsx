...
import TemplateSelectionModal from "./template-select-modal";
import { createPlayground } from "../actions";
import { PlaygroundCreate } from "../type";

const AddNewButton = () => {
    const [isModalOpen, setIsModalOpen] = useState(false);
    const [selectedTemplate, setSelectedtemplate] = useState< PlaygroundCreate | null>(null)

    const router = useRouter()

    const handleSubmit = async (data: PlaygroundCreate) => {
            ...
            >
                ...
                <div className="relative overflow-hidden">
                    <Image
                        ...
                        width={150}
                        height={150}
                        className="transition-transform bg-transparent duration-300 group-hover:scale-110"
                    />
                </div>
            </div>
